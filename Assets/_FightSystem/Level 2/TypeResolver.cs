...
namespace _2023_GC_A2_Partiel_POO.Level_2
{
    ...
    public class TypeResolver
    {
        ...
        {
            if ((attacker == TYPE.FIRE && receiver == TYPE.GRASS) || (attacker == TYPE.WATER && receiver == TYPE.FIRE) || (attacker == TYPE.GRASS && receiver == TYPE.WATER))
            {
                return 1.2f;
            }
            else if ((attacker == TYPE.FIRE && receiver == TYPE.WATER) || (attacker == TYPE.WATER && receiver == TYPE.GRASS) || (attacker == TYPE.GRASS && receiver == TYPE.FIRE))
            {
                return 0.8f;
            }
            else return 1f;

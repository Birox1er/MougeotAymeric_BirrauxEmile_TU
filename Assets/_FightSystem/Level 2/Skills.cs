...
namespace _2023_GC_A2_Partiel_POO.Level_2
{
    ...
    {
        public WaterBlouBlou() : base(TYPE.WATER, 80, StatusPotential.NONE) { }//patch à 80 puissance (anciennement 20) par soucis d'équilibrage
    }
    /// <summary>
    ...
    /// <summary>
    /// Attaque qui soigne mais inflige CRAZY
    /// </summary>
    public class Gift : Skill
    {
        public Gift() : base(TYPE.NORMAL, -40, StatusPotential.CRAZY) { }
    }
}
